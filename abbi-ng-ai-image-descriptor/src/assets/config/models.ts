...
export const MODELS: Model[] = [
  {
    ...
    name: 'GPT-4.1',
    id: 'gpt-4.1',
    description: 'Augstas kvalitātes modelis, radīts, lai sniegtu skaidras, precīzas un labi strukturētas attēlu tekstuālās alternatīvas (alt texts) īpaši piemērotsi attēlu aprakstu ģenerēšanai.',
    inputPrice: 2.0,
    outputPrice: 8.0,
    rpm: 5000,
